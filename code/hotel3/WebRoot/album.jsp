...
%>
<%@page import="dao.PhotoDao,model.Album,model.Photo"%>
<%
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        ...
        <main id="about_us_page">
            <div class="container">
                <div class="row"><!-- class="row image-gallery" -->
                   <%
    					PhotoDao dao=new PhotoDao();  
   						List<Album> list=dao.getAlbum();  
    					for(Album pojo:list){ 
    						int phid=pojo.getA_id();
    						List<Photo> plist=dao.findAllPhoto(phid);
    						
    						if(plist!=null&&plist.size()>0)
    						{ 
    							Photo p=plist.get(0);
    							System.out.print(p.getP_name());//测试
  				   %>
  				   <div class="col-md-3 col-sm-6 mt20 mb20 br2"><!--  -->
                        <a href="album-photo.jsp?phid=<%=pojo.getA_id() %>" class="hover_effect"s><!-- class=hover_effect h_lightbox h_blue -->
                            <img src="photos/<%=p.getP_name()%>"  alt="Image" width="300px" height="250px"><!-- class=img-responsive full_width br2 -->
                        </a></br>
                        <a href="album-photo.jsp?phid=<%=pojo.getA_id() %>"><%=pojo.getA_name() %></a>
                   </div> 
                   <%  
                   			}
                   			else{
                   ...
                   <div class="col-md-3 col-sm-6 mt20 mb20 br2"><!--  -->
                        <a href="album-photo.jsp?phid=<%=pojo.getA_id() %>" class="hover_effect"s><!-- class=hover_effect h_lightbox h_blue -->
                            <img src="photos/chinaz.png"  alt="Image" width="300px" height="250px"><!-- class=img-responsive full_width br2 -->
                        </a></br>
                        <a href="album-photo.jsp?phid=<%=pojo.getA_id() %>"><%=pojo.getA_name() %></a>
                   </div>
                   <%
