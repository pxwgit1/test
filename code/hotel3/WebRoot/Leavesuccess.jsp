            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="sidebar">
                            <aside class="widget">
                                <div class="vbf">
                 		 			<h2 class="form_title"><i class="fa fa-calendar"></i> 提交留言</h2>
                                    	<form name="form1" action="Leavemessage" method="get">
											<jsp:useBean id="mview" class="model.TMessage" scope="application"/>
												<p>您的留言提交成功！！
													<p><p>
													<table>
														<tr><td>留言标题：<jsp:getProperty name="mview" property="rtitle"/></td></tr>
														 <tr><td>留言内容：<p>
														 <TextArea name="rmessage" Rows="8">	
															<jsp:getProperty name="mview" property="rmessage"/></TextArea></td></tr> 
														<tr><td><a href="Checkmessage"><input type="button" value="去查看留言" /></a></td></tr>
