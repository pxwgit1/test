		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					...
					<!-- Start Sign In Form -->
					<form action="SignInServlet" class="fh5co-form animate-box" data-animate-effect="fadeIn" method="get" name="form">
						<h2>登录</h2>
						...
						<div class="form-group">
							<p>没有注册? <a href="signUp.jsp">注册</a> | <a href="forgot.jsp">忘记密码?</a></p>
						</div>
						<div class="form-group">
