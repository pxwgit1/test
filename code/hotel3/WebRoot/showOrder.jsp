...
<body>
	...
	<form action="ShowRoomInfo.jsp" method="post" name="form1">
    	<table>
    		<c:forEach var="tro" items="${olist}" varStatus="t">
    			<!-- <input type="submit" name="sure" id="sure" value="返回"> -->
    			...
    			入住时间:<input name="livetime" type="text" value="${tro['livetime']}" size=20 readonly="readonly"/><br/><br>
    			退房时间:<input name="outtime" type="text" value="${tro['outtime']}" size=20 readonly="readonly"/><br/><br>
    			预定数目:<input name="num" type="text" value="${tro['num']}" size=20 readonly="readonly"/>间<br/><br>
    			联系电话:<input name="tel" type="text" value="${tro['tel']}" size=20 readonly="readonly"/><br/><br>
    			订单编号:<input name="rtypeid" type="text" value="${tro['orderid']}" size=20 readonly="readonly"/><br/><br>
    			订单生成时间:<input name="ordertime" type="text" value="${tro['ordertime']}" size=50 readonly="readonly"/><br/><br>
    			
    			<a href="DelOrderServlet?orderid=${tro['orderid']}"><input type="button" value="删除" /></a> 				
  				<a href="UpdateOrder.jsp?orderid=${tro['orderid']}"><input type="button" value="修改" /></a>
  				<a href="RtypeServlet"><input type="button" value="返回" /></a>
  			</c:forEach> 
		</table>
  	</form>                                 
                          </div>                     
